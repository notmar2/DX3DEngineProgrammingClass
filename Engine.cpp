...
void Engine::onResize(int width, int height) {
    // Update the swap chain's back buffer size and format
    g_pSwapChain->ResizeBuffers(0, width, height, DXGI_FORMAT_UNKNOWN, 0);

    // Recreate depth/stencil buffer and render target view
    ...
    g_Projection = XMMatrixPerspectiveFovLH(XM_PIDIV4, aspectRatio, 0.1f, 1000.0f);
}
...
HRESULT Engine::InitDevice()
{
    ...
    */
    ...
    gui->init(&g_hWnd, g_pd3dDevice, g_pImmediateContext);
...
void Engine::Render()
{
    ...
    objectTest2.Move(XMFLOAT3(camTest, 2.0f, 3.0f));
